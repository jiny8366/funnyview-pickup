    ...
    <PageWrap>
      ...
      <ProductForm
        ...
        initial={{
          ...
          purchaseDiscountAmount: row.purchaseDiscountAmount ?? 0,
          purchaseDiscountPercent: row.purchaseDiscountPercent ?? 0,
          standardSupplyPrice: row.standardSupplyPrice ?? '',
          supplyDiscountAmount: row.supplyDiscountAmount ?? 0,
